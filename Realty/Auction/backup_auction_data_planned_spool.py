...
def main():
    try:
        ...
        for rstSpoolData in rstSpoolDatas:
            ...
            print("ConstRealEstateTable_AUC.CourtAuctionPlannedSpoolBackupTable => strTableForYYYY ", strTableForYYYY)

            # BAKCUP TABLE 지정
            strTargetNowYearTable = ConstRealEstateTable_AUC.CourtAuctionPlannedSpoolBackupTable+"_"+strTableForYYYY
            ...
            if strSelectedCount < 1:
                strTargetNowYearTable = ConstRealEstateTable_AUC.CourtAuctionPlannedSpoolBackupTable
            ...
            if intSelectedCount > 0:
                ...
                qryUpdateAuctionSpoolMaster = "DELETE FROM " + ConstRealEstateTable_AUC.CourtAuctionPlannedSpoolTable
            ...
            sqlSelectMasterTable += " (SELECT * FROM "+ConstRealEstateTable_AUC.CourtAuctionPlannedSpoolTable+" WHERE seq = %s AND state = '10') "
