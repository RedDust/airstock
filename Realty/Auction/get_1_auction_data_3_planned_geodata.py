...
def main():
    try:
        ...
        strMasterTable = ConstRealEstateTable_AUC.CourtAuctionPlannedTable
        ...
        # qrySelectSeoulTradeMaster += " LIMIT 4 "
        ...
        for rstSpoolData in rstSpoolDatas:
            ...
            data_5 = hjguRd = str(rstSpoolData.get('hjguRd')).strip()
            data_6 = daepyoLotno = str(rstSpoolData.get('daepyoLotno')).strip()
