...
#[국토부 아파트 실거래 자료]API URL https://apis.data.go.kr/1613000/RTMSDataSvcOffiRent/getRTMSDataSvcOffiRent
        ...
        for rstSelectData in rstSelectDatas:
            ...
            for nLoop in range(intRangeStart, intRangeEnd):
                ...
                for objectBodyItem in objectBodyItemAll:
                    ...
                    if objectBodyItem.find('offiname') != None:
                        BLDG_NM = str(objectBodyItem.find('offiname').text).strip().replace('\'',"")
                    ...
                    if objectBodyItem.find('sggNm') != None:
                        SGG_NM = str(objectBodyItem.find('sggNm').text).strip()
                    ...
                    sqlSelectMOLIT = "SELECT * FROM "+ConstRealEstateTable_GOV.MolitOfficetelRealRentMasterTable+" WHERE unique_key = %s "
                    ...
                    if intMolitCount < 1:
                        ...
                        #INSERT
                        sqlInsertMOLIT  = " INSERT INTO "+ConstRealEstateTable_GOV.MolitOfficetelRealRentMasterTable+" SET "
