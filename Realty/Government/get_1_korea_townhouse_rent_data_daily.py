...
#국토교통부 연립주택 임대차 실거래가
#SERVICE URL http://apis.data.go.kr/1613000/RTMSDataSvcRHRent/getRTMSDataSvcRHRent
#[국토교통부 연립주택 임대차 실거래가]API URL http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcRHRent
        ...
        for rstSelectData in rstSelectDatas:
            ...
            for nLoop in range(intRangeStart, intRangeEnd):
                ...
                for objectBodyItem in objectBodyItemAll:
                    ...
                    if objectBodyItem.find('mhouseNm') != None:
                        BLDG_NM = str(objectBodyItem.find('mhouseNm').text).strip().replace('\'',"")
                    ...
                    if objectBodyItem.find('houseType') != None:
                        HOUSE_TYPE = str(objectBodyItem.find('houseType').text).strip()
                    ...
                    sqlSelectMOLIT = "SELECT * FROM "+ConstRealEstateTable_GOV.MolitTownHouseRealRentMasterTable+" WHERE unique_key = %s "
                    ...
                    if intMolitCount < 1:
                        ...
                        #INSERT
                        sqlInsertMOLIT  = " INSERT INTO "+ConstRealEstateTable_GOV.MolitTownHouseRealRentMasterTable+" SET "
