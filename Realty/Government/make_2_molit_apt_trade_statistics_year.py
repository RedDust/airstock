...
def main():
    ...
    try:
        ...
        for rstSelectData in rstSelectDatas:
            ...
            strNewPartTable = ConstRealEstateTable_GOV.MolitRealTradeStatisticsMasterTableYear + "_" + strBaseYYYY
            ...
            if results < 1:
                qryCreateBackupTable = "create table " + strNewPartTable + " LIKE " + ConstRealEstateTable_GOV.MolitRealTradeStatisticsMasterTableYear
