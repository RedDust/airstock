...
def main():
    ...
    try:
        ...
        dtNowEndTime = DateTime(2024,12,13,12,30,0)
        ...
        dtNowStartTime = dtNowEndTime - TimeDelta(minutes=10)
        ...
        print("dtNowEndTime => ", listTimeDatas)
        ...
        while True:
            ...
            # print("dtNowEndTime => " , dtNowEndTime , dtNowEndTime )
        ...
        if intAffectedCount > 0:
            ...
            for rstSelectData in rstSelectDatas:
                ...
                print("listTimeDatas => " , len(listTimeDatas) , listTimeDatas)
                ...
                for listTimeDataKey in listTimeDatas:
                    ...
                    if intAffectedCount > 0:
                        ...
                        sqlSelectRecommendation = "SELECT * FROM stockfriends_koreainvest_recommendation_4 WHERE YYYYMMDD = %s AND HHII = %s AND sectors_code =%s"
