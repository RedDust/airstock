...
def main():
    try:
        ...
        sqlUpdateStockItem += " WHERE state = '03' "
        cursorStockFriends.execute(sqlUpdateStockItem)
        intBeforeCount = cursorStockFriends.rowcount

        strCountryCode = "kr"
        RealtyCallUrl = 'https://finance.naver.com/sise/management.naver'
        ...
        for rstTableTbodyTrElement in rstTableTbodyTrElements:
            ...
            print("rstTableTbodyTrElement ====================>", len(rstTableTbodyTrTdElements) , rstTableTbodyTrElement)
            if len(rstTableTbodyTrTdElements) == 8:
                ...
                strStopDate = rstTableTbodyTrTdElements[6].getText().replace(".","-")
